        ...
        {({ isSubmitting, values, setValues }) => (
          <Form>
            <TextFormField
              ...
              subtext={`The custom name you are giving TARS for your team. This will replace 'TARS' everywhere in the UI.`}
              placeholder="Custom name which will replace 'TARS'"
            ...
            <div>
              ...
              {values.use_custom_logo ? (
                ...
                <SubLabel>
                  Specify your own logo to replace the standard TARS logo.
                </SubLabel>
              )}
