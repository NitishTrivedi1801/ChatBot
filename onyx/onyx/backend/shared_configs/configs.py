...
# for inference
INDEXING_MODEL_SERVER_HOST = os.environ.get("INDEXING_MODEL_SERVER_HOST") or "indexing_model_server"
INDEXING_MODEL_SERVER_PORT = int(os.environ.get("INDEXING_MODEL_SERVER_PORT") or "8002")
