...
def get_application(lifespan_override: Lifespan | None = None) -> FastAPI:
    prefix = os.getenv("APP_API_PREFIX", "/api")
    application = FastAPI(
        title="Onyx Backend",
        version=__version__,
    ...
    # Add all routers to api_router
    api_router.include_router(password_router)
    api_router.include_router(chat_router)
    api_router.include_router(query_router)
    api_router.include_router(document_router)
    api_router.include_router(user_router)
    api_router.include_router(admin_query_router)
    api_router.include_router(admin_router)
    api_router.include_router(connector_router)
    api_router.include_router(credential_router)
    api_router.include_router(input_prompt_router)
    api_router.include_router(admin_input_prompt_router)
    api_router.include_router(cc_pair_router)
    api_router.include_router(user_documents_router)
    api_router.include_router(folder_router)
    api_router.include_router(document_set_router)
    api_router.include_router(search_settings_router)
    api_router.include_router(slack_bot_management_router)
    api_router.include_router(persona_router)
    api_router.include_router(admin_persona_router)
    api_router.include_router(notification_router)
    api_router.include_router(tool_router)
    api_router.include_router(admin_tool_router)
    api_router.include_router(state_router)
    api_router.include_router(onyx_api_router)
    api_router.include_router(gpts_router)
    ...
    api_router.include_router(token_rate_limit_settings_router)
    api_router.include_router(get_full_openai_assistants_api_router())
    api_router.include_router(long_term_logs_router)
    api_router.include_router(api_key_router)
    api_router.include_router(standard_oauth_router)

    if AUTH_TYPE == AuthType.DISABLED:
        pass

    if AUTH_TYPE == AuthType.BASIC or AUTH_TYPE == AuthType.CLOUD:
        api_router.include_router(fastapi_users.get_auth_router(auth_backend), prefix="/auth")
        api_router.include_router(fastapi_users.get_register_router(UserRead, UserCreate), prefix="/auth")
        api_router.include_router(fastapi_users.get_reset_password_router(), prefix="/auth")
        api_router.include_router(fastapi_users.get_verify_router(UserRead), prefix="/auth")
        api_router.include_router(fastapi_users.get_users_router(UserRead, UserUpdate), prefix="/users")
    ...
    if AUTH_TYPE == AuthType.GOOGLE_OAUTH:
        ...
        api_router.include_router(fastapi_users.get_logout_router(auth_backend), prefix="/auth")
    ...
    if (
        ...
        api_router.include_router(fastapi_users.get_refresh_router(auth_backend), prefix="/auth")
