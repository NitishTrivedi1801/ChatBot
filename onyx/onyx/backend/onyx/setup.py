# WARNING: Do NOT use Base.metadata.create_all or engine.create_all in production or app startup code!
# All table creation must be handled via Alembic migrations only.
# Accidental use of create_all can break migrations and production data integrity.
#
# If you need to create tables, write a migration instead.
