...
DO $$
BEGIN
    IF to_regclass('public.index_attempt_errors') IS NOT NULL AND to_regclass('public.index_attempt') IS NOT NULL THEN
        EXECUTE 'TRUNCATE TABLE index_attempt_errors, index_attempt CASCADE';
    ELSIF to_regclass('public.index_attempt') IS NOT NULL THEN
        EXECUTE 'TRUNCATE TABLE index_attempt CASCADE';
    END IF;
END
$$;
""")
